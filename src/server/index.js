//Authentication to SalesForce instance
// This is a username and password based login
...
module.exports = app => {
    ...
    uses an inner query using the 
    Session Speakers junction object.*/
        conn.query(soql, (err, result) => {
            if (err) {
                ...
                /* Result data --->
    jsforce query method you use the SOQL 
    statement to run that query using the 
